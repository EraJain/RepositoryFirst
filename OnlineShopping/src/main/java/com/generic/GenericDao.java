...
public class GenericDao {
	...
	public Customer findCustomer(Customer customer) throws NoCustomerFound, DAOException {
	...
	public void updateCustomer(Customer customer) throws NoCustomerFound, DAOException {
